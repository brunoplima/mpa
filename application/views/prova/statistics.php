...
<hr>
<button type="button" class="btn btn-primary pull-left" id="redo">Gerar nova prova <span class="glyphicon glyphicon-file"></span></button>
<div class="prova_timestamp">Prova corrigida em <?php echo $stats['time']?></div>
